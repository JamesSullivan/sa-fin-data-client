...
) -> HTTPValidationError | Identifier | None:
    if response.status_code == 200:
        response_200 = Identifier.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | Identifier]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Identifiers
     ...
     Fetch various identifiers for a given company.

    Returns:
        Identifier: name, primary_exchange, primary_exchange_symbol, cik, figi, org_permid, isin, cusip
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | Identifier
    """
